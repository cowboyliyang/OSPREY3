...
public class BranchMARKStarBound extends MARKStarBound {
    ...
    public BranchMARKStarBound(SimpleConfSpace confSpace, EnergyMatrix rigidEmat,
        ...
        this.regionAtomEnabled = getConfigBoolean(REGION_ATOM_ENABLED_PROPERTY, false);
        this.regionAtomScoutOnly = getConfigBoolean(REGION_ATOM_SCOUT_ONLY_PROPERTY, false);
        ...
        this.regionAtomWhatIfDeltas = parseDoubleList(
                getConfigProperty(REGION_ATOM_WHATIF_DELTAS_PROPERTY, "0.1,0.3,0.5"));
        ...
        if (regionAtomEnabled) {
            System.out.println("BranchMARK*: Region-atom table scout enabled"
    ...
    private static double[] parseDoubleList(String value) {
        ...
        for (String field : fields) {
            ...
            try {
                ...
                System.err.println("BranchMARK*: Invalid double in list: '" + trimmed + "', skipping.");
            }
        }
    ...
    private void initRegionAtoms(RCs rcs) {
        ...
        for (int[] region : regions) {
            ...
            // minimizingEcalc to be non-null (it always is in BranchMARK* runs).
    ...
    private void recordScoutLeaf(DecompSearchNode leaf) {
        ...
        // Require fully assigned leaf (regular BranchMARK* leaves satisfy this).
    ...
    private void printCorrectionAuditStats() {
        ...
        if (useHigherOrderCorrections && useSparsePfunc) {
            System.out.println("BranchMARK*: Correction audit note: SPARSE mode skips correctionMatrix applications "
