...
#     print('minimization complete!')
    ...
    path = '3bte.df.i.min.pdb'
    open(path, 'w').write(osprey.prep.savePDB(ligand))
    path = '3bte.df.e.min.pdb'
    open(path, 'w').write(osprey.prep.savePDB(target))
