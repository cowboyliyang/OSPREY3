#!/bin/bash
# Freeze, compile, checksum, and submit the 3BUA SPACK* interaction probe.
...
SLURM_SCRIPT="$REPO/slurm/scripts/run_spackstar_3bua_envelope_probe.slurm"

mkdir -p "$SNAPSHOT_PARENT"
SNAPSHOT=$(mktemp -d "$SNAPSHOT_PARENT/3bua_probe.XXXXXXXX")
