...
cmd=['/home/users/lz280/java/jdk-17.0.2+8/bin/java',
     ...
     '-Xmx160g','-Xms4g','-XX:-UseSuperWord','-XX:ActiveProcessorCount=16',
...
shutil.copy2(prep/'package/protocol.json',root/'protocol.json')
...
manifest=dict(design_id=row['design_id'],system=row['system'],task=task,
              ...
              ccd='CPU',gpus=0,cpus=16,memory_gib=192,heap_gib=160,
